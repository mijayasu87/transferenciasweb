...
public class LicenciaUso implements Serializable {
    ...
    @Column(name = "terminacion_no")
    private Integer terminacionNo;
    
    @Column(name = "fecha_terminacion")
    @Temporal(javax.persistence.TemporalType.DATE)
    private Date fechaTerminacion;
    
    @Column(name = "terminacion_notificada")
    private boolean terminacionNotificada;
    ...
    /**
     * @return the terminacionNo
     */
    public Integer getTerminacionNo() {
        return terminacionNo;
    }

    /**
     * @param terminacionNo the terminacionNo to set
     */
    public void setTerminacionNo(Integer terminacionNo) {
        this.terminacionNo = terminacionNo;
    }
    ...
    /**
     * @return the terminacionNotificada
     */
    public boolean isTerminacionNotificada() {
        return terminacionNotificada;
    }

    /**
     * @param terminacionNotificada the terminacionNotificada to set
     */
    public void setTerminacionNotificada(boolean terminacionNotificada) {
        this.terminacionNotificada = terminacionNotificada;
    }
