 ...
 */
package senadi.gob.ec.transfweb.model.cd;
...
public class CambioDomicilio implements Serializable {
    @Id
    @Column(name = "id")
    private Integer id;
    ...
    @Column(name = "ti_apod_repre")
    private String tiApodRepre;
    ...
    /**
     * @return the tiApodRepre
     */
    public String getTiApodRepre() {
        return tiApodRepre;
    }

    /**
     * @param tiApodRepre the tiApodRepre to set
     */
    public void setTiApodRepre(String tiApodRepre) {
        this.tiApodRepre = tiApodRepre;
    }
