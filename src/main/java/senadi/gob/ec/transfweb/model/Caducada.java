...
public class Caducada implements Serializable {
    ...
    @Column(name = "pais_titular_actual")
    private String paisTitularActual;

    @Column(name = "apoderado_representante")
    private String apoderadoRepresetante;
    ...
    @Column(name = "notificada_caducada")
    private boolean notificadaCaducada;
    ...
    /**
     * @return the paisTitularActual
     */
    public String getPaisTitularActual() {
        return paisTitularActual;
    }

    /**
     * @param paisTitularActual the paisTitularActual to set
     */
    public void setPaisTitularActual(String paisTitularActual) {
        this.paisTitularActual = paisTitularActual;
    }

    /**
     * @return the apoderadoRepresetante
     */
    public String getApoderadoRepresetante() {
        return apoderadoRepresetante;
    }

    /**
     * @param apoderadoRepresetante the apoderadoRepresetante to set
     */
    public void setApoderadoRepresetante(String apoderadoRepresetante) {
        this.apoderadoRepresetante = apoderadoRepresetante;
    }
    ...
    /**
     * @return the notificadaCaducada
     */
    public boolean isNotificadaCaducada() {
        return notificadaCaducada;
    }

    /**
     * @param notificadaCaducada the notificadaCaducada to set
     */
    public void setNotificadaCaducada(boolean notificadaCaducada) {
        this.notificadaCaducada = notificadaCaducada;
    }
}
