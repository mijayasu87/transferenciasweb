...
public class ProrrogaLicenciaBean implements Serializable {
    ...
    public boolean isProrrogaVencida(LicenciaUso p) {
    ...
    public String getEstiloProrroga(LicenciaUso p) {
        if (p == null || p.getFechaPuestaProrroga() == null || p.getDiasProrroga() == null) {
            return "";
        }
    ...
    public String getDiasRestantes(LicenciaUso p) {
        if (p == null || p.getFechaPuestaProrroga() == null || p.getDiasProrroga() == null) {
            return "";
        }
        LocalDate limite = Operaciones.calcularFechaLimiteProrroga(p.getSolicitud(), p.getFechaPuestaProrroga(), p.getDiasProrroga());
    ...
    public String getTooltipProrroga(LicenciaUso p) {
        if (p == null || p.getFechaPuestaProrroga() == null || p.getDiasProrroga() == null) {
            return "";
        }
        LocalDate limite = Operaciones.calcularFechaLimiteProrroga(p.getSolicitud(), p.getFechaPuestaProrroga(), p.getDiasProrroga());
                ...
                if (estadoTemp != null && !estadoTemp.trim().isEmpty()) {
                    if (estadoTemp.equals("CERTIFICADO")) {
                        ...
                        if (prorroga.getNumeroAbandono() == null) {
                            prorroga.setNumeroAbandono(c.getNextNumeroAbandonoLicencia(new Date()));
                        }
                    } else {
